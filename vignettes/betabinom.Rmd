...
```{r}
d <- read.delim("https://github.com/fulcrumgenomics/betabinom/data/example-3groups.txt?raw=true")
...
```{r}
d <- read.delim("https://github.com/fulcrumgenomics/betabinom/data/example-paired.txt?raw=true")
